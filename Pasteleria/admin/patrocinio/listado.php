...
<body>
    ...
    <a href="../index.php" class="btn btn-primary mb-4">Volver</a>
        ...
        <h1 class="mb-4">Productos con Patrocinio</h1>
        <div class="table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    <?php
                    $con_sql="SELECT * FROM productos2  ";
                    ...
                    <tr>
                        ...
                        <td><a href="" class="btn btn-danger btn-sm">AGOTADO</a></td>
                        <td><a href="" class="btn btn-success btn-sm">MODIFICAR</a></td>
                    </tr>
                    <?php
                    }
                    ?>
